...
def send_email_verification_email(to_email, verify_url, ttl_minutes):
    smtp_host = os.getenv("SMTP_HOST")
    smtp_port = int(os.getenv("SMTP_PORT", "587"))
    smtp_user = os.getenv("SMTP_USERNAME")
    smtp_pass = os.getenv("SMTP_PASSWORD")
    ...
    msg.set_content(
        ...
        f"Verification link (valid for {ttl_minutes} minutes):\n{verify_url}\n\n"
    ...
    <body>
        ...
        <p><a href="{verify_url}">Verify email</a> (valid for {ttl_minutes} minutes)</p>
